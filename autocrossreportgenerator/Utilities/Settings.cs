...
namespace autocrossreportgenerator.Utilities
{
    public class Settings
    {
        ...
        public string LogPath = @"C:\ProgramData\autocrossreportgenerator\autocrossreportgenerator.log";

        [XmlIgnore]
        public const string SettingsPath = @"C:\ProgramData\autocrossreportgenerator\";
